<template>
  <div style="display: flex;">
    ...
    >
      ...
      > 
        <template slot-scope="scope">
          <el-button size="mini" type="primary" @click="clickPassButton(scope.row)">通过</el-button>
          <el-button size="mini" type="warning" @click="clickRejectButton(scope.row)">拒绝</el-button>
...
export default {
  ...
  methods: {
    ...
    async reFindUserData() {
      // 0 待审核
      const res = await getUsersData(0)
